...
class DenseVAE(BaseVAE):
    ...
    def get_encoder(self):
        ...
        z = Flatten()(inputs)
        z = Dense(1024, activation=self.activation)(z)
        z = BatchNormalization()(z)
        z = Dense(512, activation=self.activation)(z)
        z = BatchNormalization()(z)
        z = Dense(256, activation=self.activation)(z)
        z = BatchNormalization()(z)
        z = Dense(128, activation=self.activation)(z)
        z = BatchNormalization()(z)
        z = Dense(64, activation=self.activation)(z)
    ...
    def get_decoder(self):
        ...
        x = Dense(64, activation=self.activation)(decoder_inputs)
